...
<html lang="fr">
    ...
    <body class="hold-transition skin-blue sidebar-mini">
                        ...
                        <div class="box-body">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>  
                                        <td id="td"> <!-- TODO td . $unHobbie "id" --> <!-- TODO : ICI la class fait de la merde, à voir plus tard ! ... -->
                                            TODO NOMS HOBBIE
                                        </td>
                                        ...
                                        <td> <!-- TODO : ICI la class fait de la merde, à voir plus tard ! ... -->
                                            <div class="row">
                                                ...
                                                <div class="col-md-1">
                                                    <form action="admin_hobbie_edit.php" method="get">
                                                        <input type="hidden" value="destroy" name="destroy"/> <!-- TODO change destroy to ID -->
        ...
        echo "<pre>";
        var_dump(readAllHobbie());
        echo "</pre>";

        echo "</br>";
        echo "</br>";

        $lesTest = readAllHobbie();
        foreach ($lesTest as $unTest) {
            echo $unTest['titre_hobbie'] . "</br>";
        }
        
        echo "</br>";
        echo "</br>";
        
        var_dump(readOneHobbie(1));
        ?>
